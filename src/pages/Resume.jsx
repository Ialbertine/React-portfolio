...
const Resume = () => {
  return (
    <div className="flex flex-col items-center w-full">
      <h1 className="text-5xl pt-[2rem] lg:pt-[4rem] font-extrabold">RESUME</h1>
      ...
      <div class="flex flex-col md:flex-row md:w-[90%] gap-[5rem] items-center justify-center mt-11">
        ...
        <div class="w-[90%] lg:w-[35%]">
          ...
          <div class="border-b border-gray-200 py-4">
            ...
            <h1 className="text-xl font-bold pt-3">STANFOLD UNIVERSITY'S COURSE</h1>
            <p className="pt-3">
      ...
      <div className="max-w-screen-lg max-auto p-4 flex flex-col items-center">
        ...
        <div className="grid grid-cols-3 gap-x-5 gap-y-5 lg:gap-x-[2rem] lg:gap-y-[2rem] mt-6">
          <div className="w-[8.5rem] md:w-[12rem] lg:w-[18rem] shadow-md hover:shadow-[#694888] duration-500 py-2 rounded-lg flex flex-col items-center">
            <img
              src="img/html-icon.svg"
              alt="html"
          ...
          <div className="w-[8.5rem] md:w-[12rem] lg:w-[18rem] shadow-md hover:shadow-[#694888] duration-500 py-2 rounded-lg flex flex-col items-center">
            <img
              src="img/javascript-programming-language-icon.svg"
              alt="javascript"
              className="w-20 max-auto mt-6"
            />
            <span className="text-center mt-4">JAVASCRIPT</span>
          </div>
          <div className="w-[8.5rem] md:w-[12rem] lg:w-[18rem] shadow-md hover:shadow-[#694888] duration-500 py-2 rounded-lg flex flex-col items-center">
            <img
              src="img/react-js-icon.svg"
              alt="react"
              className="w-20 max-auto mt-6"
            />
            <span className="text-center mt-4">REACT JS</span>
          </div>
          <div className="w-[8.5rem] md:w-[12rem] lg:w-[18rem] shadow-md hover:shadow-[#694888] duration-500 py-2 rounded-lg flex flex-col items-center">
            <img
              src="img/tailwind-css-icon.svg"
              alt="tailwindcss"
              className="w-20 max-auto mt-6"
            />
            <span className="text-center mt-10">TAILWINDCSS</span>
          </div>
          <div className="w-[8.5rem] md:w-[12rem] lg:w-[18rem] shadow-md hover:shadow-[#694888] duration-500 py-2 rounded-lg flex flex-col items-center">
            <img
              src="img/github.svg"
              ...
              className="w-20 max-auto mt-6"
            />
            <span className="text-center mt-2">GITHUB</span>
          </div>
        </div>
      </div>
    </div>
